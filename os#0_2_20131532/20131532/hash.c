...
unsigned hashswan(const struct hash_elem *e,void *aux)
{
		return hash_int(hash_entry(e,struct hash_item,elem)->data);
}
bool hashbrown(const struct hash_elem *a,const struct hash_elem *b,void *aux)
{
...
void hashdeleter (struct hash_elem *e, void *aux)
{
	if(e !=NULL)
...
{
	hash_entry(e,struct hash_item,elem)->data = hash_entry(e,struct hash_item,elem)->data*hash_entry(e,struct hash_item,elem)->data;
}
void triple(struct hash_elem *e, void *aux)
{
	hash_entry(e,struct hash_item,elem)->data = hash_entry(e,struct hash_item,elem)->data*hash_entry(e,struct hash_item,elem)->data*hash_entry(e,struct hash_item,elem)->data;
